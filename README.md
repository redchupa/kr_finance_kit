...
[![Latest](https://img.shields.io/github/v/release/redchupa/kr_finance_kit?label=latest)](https://github.com/redchupa/kr_finance_kit/releases)
...
| 필드 | 예시 | 효과 |
|---|---|---|
| **OpenDart API 키** (선택) | `14ab...` | 공시 모니터링 + 종목명 매핑 활성화. [opendart.fss.or.kr](https://opendart.fss.or.kr)에서 무료 즉시 발급 |
...
종목코드 모르면 화면 안의 **KRX 상장법인 목록 · 네이버 금융 · Yahoo Finance Lookup** 링크가 바로 안내합니다.
